...
const productsCollection = defineCollection({
  ...
  schema: z.object({
    ...
    trailerType: z.enum(['ben', 'sàn', 'sàn-rút', 'lùn', 'cổ-cò', 'xương', 'lửng', 'lồng', 'rào', 'xi-téc', 'bồn-xi-măng', 'bồn-sắt', 'bồn-bột-mì', 'đông-lạnh', 'hút-chất-thải', 'bồn-nh3', 'bồn-ni-tơ', 'bồn-hóa-chất', 'bồn-bột-pvc', 'bồn-nhựa-đường', 'bồn-thức-ăn', 'bồn-lpg', 'bồn-methanol']).optional(),
